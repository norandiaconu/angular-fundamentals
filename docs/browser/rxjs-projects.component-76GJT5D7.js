...
var RxjsProjectsComponent = class _RxjsProjectsComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RxjsProjectsComponent, selectors: [["rxjs-projects"]], decls: 39, vars: 3, consts: [["title", "Start dog subscription", "id", "dogSub", 3, "click"], ["title", "Start and stop dog polling", "id", "dogStart", 3, "click"], ["title", "Start and stop dog polling", "id", "dogStop", 3, "click"], ["id", "dog", "alt", "dog", "src", "https://random.dog/967eae80-8f34-490b-944c-4f6bd4697712.jpeg", 2, "height", "190px"], ["id", "dogVid", "alt", "dog", "src", "https://random.dog/c494d883-9a34-4d8d-b0b3-449069c30f23.mp4", "autoplay", "", "loop", "", 2, "height", "190px"], ["label", "English", "kind", "subtitles"], ["title", "Start mortgage subscription", "id", "mortgageSub", 3, "click"], ["for", "loanAmount"], ["type", "number", "name", "loanAmount", "id", "loanAmount"], ["for", "interest"], ["type", "number", "name", "interest", "id", "interest"], ["for", "loanLength"], ["type", "radio", "name", "loanLength", "value", "180", 1, "loanLength"], ["type", "radio", "name", "loanLength", "value", "360", 1, "loanLength"], ["id", "expected"]], template: function RxjsProjectsComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275domListener("click", function RxjsProjectsComponent_Template_button_click_2_listener() {
        return ctx.dogSub();
      });
      \u0275\u0275text(3);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(4, "button", 1);
      \u0275\u0275domListener("click", function RxjsProjectsComponent_Template_button_click_4_listener() {
        return ctx.dogStart();
      });
      \u0275\u0275text(5, "Start Polling");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(6, "button", 2);
      \u0275\u0275domListener("click", function RxjsProjectsComponent_Template_button_click_6_listener() {
        return ctx.dogStop();
      });
      \u0275\u0275text(7, "Stop Polling");
      \u0275\u0275domElementEnd();
      \u0275\u0275text(8);
      \u0275\u0275domElement(9, "br")(10, "br")(11, "img", 3);
      \u0275\u0275domElementStart(12, "video", 4);
      \u0275\u0275domElement(13, "track", 5);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(14, "br")(15, "br");
      \u0275\u0275text(16, "\nMortgage Calculator:");
      \u0275\u0275domElement(17, "br");
      \u0275\u0275domElementStart(18, "button", 6);
      \u0275\u0275domListener("click", function RxjsProjectsComponent_Template_button_click_18_listener() {
        return ctx.mortgageSub();
      });
      \u0275\u0275text(19);
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(20, "br");
      \u0275\u0275domElementStart(21, "label", 7);
      \u0275\u0275text(22, "Mortgage Amount ($)");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(23, "input", 8)(24, "br");
      \u0275\u0275domElementStart(25, "label", 9);
      \u0275\u0275text(26, "Interest Rate (%)");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(27, "input", 10)(28, "br");
      \u0275\u0275domElementStart(29, "label", 11);
      \u0275\u0275text(30, "Mortgage Length");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElement(31, "input", 12);
      \u0275\u0275text(32, " 15 yr\n");
      \u0275\u0275domElement(33, "input", 13);
      \u0275\u0275text(34, " 30 yr\n");
      \u0275\u0275domElement(35, "br")(36, "br");
      \u0275\u0275text(37, "\nYour expected monthly payment is:\n$");
      \u0275\u0275domElement(38, "strong", 14);
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
